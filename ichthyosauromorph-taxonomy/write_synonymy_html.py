...
<h3 class="valid-taxon">accepted_name [@accepted_authority]</h3>\n
'''
...
<li>
assignment_confidence &ensp; <span class="species">identified_name [@identified_authority] identified_note &ensp; @reference pagerref\n
<ul class="synonym">\n
locality_info\n
</ul>\n
</li>\n
...
with open(outfile, 'wt') as out_file:
    ...
    for taxon in taxa_to_print:
        ...
        if len(these_synonyms) > 0:
            ...
            these_synonyms = '<ul class="synonymy">\n' + these_synonyms + '</ul>\n\n'
